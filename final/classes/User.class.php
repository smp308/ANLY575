...
class User extends Base {
	...
	function processRegistration() {
		if($_SERVER["REQUEST_METHOD"] == "POST"){
			...
			$result = array();
			$result['first_name'] = $this->validateFirstname($postFirstname);
			$result['last_name'] = $this->validateLastname($postLastname);
			...
			if ($this->registrationDataOk($result) === false) {
				...
				$db = new Database();
				$insertSql = "INSERT INTO `users` (`first_name`, `last_name`, `email`, `password`) ";
